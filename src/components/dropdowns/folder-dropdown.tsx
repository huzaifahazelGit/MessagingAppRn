...
import { useMe, useMyFolders } from "../../hooks/useMe";
Feather.loadFont();

export const FolderDropdown = ({ selectedFolder, setSelectedFolder }) => {
  ...
  return (
    <AutocompleteDropdown
      ...
      initialValue={selectedFolder ? selectedFolder.id : undefined}
